...
<body class="bg-gray-100">
        ...
        <div class="p-5 flex-1">
            ...
            <div class="relative mb-4">
                ...
                <input type="text" placeholder="Cari Produk"
                    class="w-full bg-gray-100 border border-gray-300 text-gray-600 py-2 px-3 rounded-lg">
            ...
            <div class="space-y-4 overflow-y-auto max-h-[300px]">
                <!-- Produk Item -->
                <div id="cart-items"
                    class="bg-green-50 border border-green-300 p-4 rounded-lg flex items-center justify-between mb-4">
            ...
            <div class="bg-green-50 px-5 py-4 border-t border-green-300">
                ...
                <div class="text-right">
                    <a href="/jadwalpesanan"
                        class="bg-green-500 text-white py-2 px-4 rounded-lg text-sm font-semibold">Selanjutnya</a>
                </div>
            </div>
        </div>
        <!-- Footer Navigasi -->
    ...
    <script>
        // Ambil cart dari Session Storage
        function getCart() {
