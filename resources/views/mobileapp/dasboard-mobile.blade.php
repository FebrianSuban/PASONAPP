...
<html lang="id">
    ...
    <body class="bg-gray-100">
            ...
            <div class="grid grid-cols-2 gap-4 p-5" id="product-list">
                ...
                >
                    <div class="rounded-lg">
                        <img
                            src="/img/640-vegetable-and-herb-pile-of-water-spinach-or-ipomoea-aquatica-selling-at-fresh-market-in-indonesian-it-is-called-kangkung-dfd91bf15551cc4a39deb2d33910fe0a-20d6a116be547391129088e1f2ef936c_600x400.jpg"
                            alt="Foto Produk"
        ...
        <script>
            ...
            axios
                .get("http://127.0.0.1:1337/api/products??pagination[page]=1&pagination[pageSize]=100")
