...
<body class="bg-gray-100">
    <div class="max-w-sm mx-auto bg-white min-h-screen relative pb-20">
        ...
        <div class="relative w-24 h-24 mx-auto mt-5">
            ...
            <div class="absolute bottom-0 right-0 w-8 h-8 bg-green-400 rounded-full flex justify-center items-center">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                    ...
                    <path
                        d="M12 15.5C14.21 15.5 16 13.71 16 11.5C16 9.29 14.21 7.5 12 7.5C9.79 7.5 8 9.29 8 11.5C8 13.71 9.79 15.5 12 15.5ZM19 3H5C3.89 3 3 3.9 3 5V19C3 20.1 3.89 21 5 21H19C20.11 21 21 20.1 21 19V5C21 3.9 20.11 3 19 3ZM19 19H5V5H19V19Z"
                        fill="white" />
                </svg>
            </div>
        </div>
        ...
        <div class="bg-green-100 rounded-2xl p-5 mx-5 mt-20">
            <div class="flex mb-4">
                ...
                <span class="w-2/3 text-gray-800" data-name>Loading...</span>
            </div>
            <div class="flex mb-4">
                <span class="w-1/3 font-semibold text-gray-600">Alamat :</span>
                <span class="w-2/3 text-gray-800" data-address>Loading...</span>
            </div>
            <div class="flex mb-4">
                <span class="w-1/3 font-semibold text-gray-600">Nomor HP :</span>
                <span class="w-2/3 text-gray-800" data-phone>Loading...</span>
            </div>
            <div class="flex mb-4">
            ...
            <table class="w-full mb-4">
                <thead>
                    <tr>
                        ...
                        <th class="text-right text-gray-800" data-total-orders>Loading...</th>
                    </tr>
                </thead>
            </table>
            <table class="w-full mb-4">
        ...
        <!-- Tombol Edit -->
        <button
            class="bg-green-500 text-white py-2 px-6 rounded-2xl font-medium text-base mx-auto block mt-6 hover:bg-green-600 transition mt-15"
            onclick="redirectToPageEditProfile()">
            Edit
        </button>
        <div
    ...
    <script>
        ...
        function redirectToPageEditProfile() {
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (profileData) {
                ...
                document.querySelector("[data-name]").innerText = profileData.name || "Tidak Ada Data";
